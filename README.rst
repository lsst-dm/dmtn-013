...
.. code-block:: bash
   ...
   git clone https://github.com/lsst-dm/dmtn-013
   cd dmtn-013
...
The published technote at http://dmtn-013.lsst.io will be automatically rebuilt whenever you push your changes to the ``master`` branch on `GitHub <https://github.com/lsst-dm/dmtn-013>`_.
